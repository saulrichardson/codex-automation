export function buildWorkPrompt(taskInstructions: string): string {
  return [
...
export function buildValidationPrompt(taskInstructions: string, validationPlan: string): string {
  return [
...
export function buildReflectionPrompt(validationReport: string): string {
  return [
    "Validator report:",
    "```",
    validationReport,
